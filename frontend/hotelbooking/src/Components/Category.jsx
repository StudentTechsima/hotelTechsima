...
const Category = () => {
    ...
    const fetchCategory = async () => {
        setLoader(true)
        try {
            const res = await fetch(`https://hoteltechsima-backend.onrender.com/client/get-all-category`, {
                method: "GET"
            })
                    ...
                    category.map((item) => {
                        return (
                            <div className="wrapper" key={item._id}>
                                ...
                                <div className="image">
                                    <img src={`https://hoteltechsima-backend.onrender.com/${item.room_category_image}`} alt="delux room price" title='delux room' />
                                </div>
