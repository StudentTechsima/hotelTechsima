...
const AddRoom = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`https://hoteltechsima-backend.onrender.com/admin/api/add-room`, formData, { headers: { Authorization: `Bearer ${localStorage.getItem('admintoken')}` } })
